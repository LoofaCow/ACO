...
const settingsAdvanced = {
    loadAdvancedTab() {
      document.getElementById("settings-content").innerHTML = `
        <div class="advanced-settings modern-form">
          ...
          <div class="form-group">
            ...
            <input type="text" id="stop-sequences" class="bubble-input" placeholder="e.g. \n, , '###'">
          </div>
      ...
      document.getElementById('stop-sequences').value = localStorage.getItem('stopSequences') || '';
      ...
      document.getElementById('save-advanced-params').addEventListener('click', () => {
        ...
        const stopSequences = document.getElementById('stop-sequences').value;
